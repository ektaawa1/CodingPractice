 ...
 * lexicographical order means dictionary order, i.e.: A → Z (ascending order)
 *
 * Example 1:
...
/**
 * Why b.compareTo(a) Is Correct???
 *If frequencies equal: return b.compareTo(a);
 * Now lexicographically larger word is considered “smaller” in heap.
 * So "love" comes before "i" in heap order.
 * So when heap size exceeds k:
 * "love" gets removed
 * "i" stays
 */
